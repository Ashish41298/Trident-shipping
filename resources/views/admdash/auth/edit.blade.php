  ...
  <div class="formbox" style="max-width: 350px; width:350px;">
    <form action="{{route('update',$user->id)}}" method="post" >
        ...
        <div class="mb-3 text-start">
          ...
          <input type="text" class="form-control" name="name" placeholder="Enter the name" value="{{$user->name}}">
          @error('name')
        ...
        <div class="mb-3 text-start">
            ...
            <input type="email" class="form-control" name="email" placeholder="Enter the Email" value="{{$user->email}}">
            @error('email')
            <div style="color: crimson;" class="form-text">
                {{$message}}
              </div>
